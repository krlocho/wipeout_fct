<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('reparaciones.index')" :active="request()->routeIs('reparaciones.index')">
                        {{ __('Reparaciones') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                <div class="text-base font-medium text-gray-800 dark:text-gray-200">@if(Auth::check())
                    <!-- Menú de navegación -->
                    <nav>
                        <!-- Contenido del menú de navegación -->
                        {{ Auth::user()->name }}
                ...
                @endif</div>
                <div class="text-sm font-medium text-gray-500">@if(Auth::check())
                    <!-- Menú de navegación -->
                    <nav>
                        <!-- Contenido del menú de navegación -->
                        {{ Auth::user()->email }}
