<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="latitud" name="latitud" type="text" class="block w-full mt-1" :value="old('latitud', $user->latitud)" required autofocus autocomplete="latitud" />
            <x-input-error class="mt-2" :messages="$errors->get('latitud')" />
        </div>

        <div>
            <x-input-label for="longitud" :value="__('Longitud')" />
            <x-text-input id="longitud" name="longitud" type="text" class="block w-full mt-1" :value="old('longitud', $user->longitud)" required autofocus autocomplete="longitud" />
            <x-input-error class="mt-2" :messages="$errors->get('latitud')" />
        </div>
