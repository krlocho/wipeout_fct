...
<div class="mt-4">
    ...
    <x-text-input id="phone" class="block w-full mt-1"
                  type="text"
                  name="phone" required />
...
<div class="mt-4">
    ...
    <x-text-input id="latitud" class="block w-full mt-1"
                  type="text"
...
<div class="mt-4">
    ...
    <x-text-input id="longitud" class="block w-full mt-1"
                  type="text"
    ...
    <x-input-error :messages="$errors->get('longitud')" class="mt-2" />
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <a href="{{ route('login.google') }}">Registrarse con Google</a>
